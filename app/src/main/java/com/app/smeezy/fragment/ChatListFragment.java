...
import com.app.smeezy.adapter.ChatListAdapter;
 ...
 */
public class ChatListFragment extends BaseFragment implements IRequestView {

    private static final String GET_CHAT_LIST = "get_chat_list";
    ...
    private void getChatList() {
        if (cd.isConnectingToInternet()) {
            requestPresenter.getChatList(GET_CHAT_LIST, PreferenceUtils.getId(mContext), "public");
        } else {
   ...
   /* @Override
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.fragment_chat_list_menu, menu);

        SearchView searchView = (SearchView) menu.findItem(R.id.chat_list_search).getActionView();
        menu.findItem(R.id.chat_list_search).expandActionView();
        ...
        switch (method) {
            ...
            case GET_CHAT_LIST:
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    ChatListItem chatListItem = gson.fromJson(currentData.toString(), ChatListItem.class);
