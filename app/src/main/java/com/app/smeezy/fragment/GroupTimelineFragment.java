...
import com.app.smeezy.adapter.GroupTimelineAdapter;
 ...
 */
public class GroupTimelineFragment extends BaseFragment implements IRequestView, FeedListener,
    ...
    private static final int COMMENT_REQUEST = 223;
    private static final int REPORT_REQUEST = 1021;


    @BindView(R.id.et_group_message)
    ...
    private GroupTimelineAdapter mAdapter;
    private int page = 1;
    private int likePosition, commentPosition, deletePosition, reportPosition;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_group_timeline, container, false);
        ...
        mAdapter = new GroupTimelineAdapter(mContext, recyclerView, feedList, this);
    ...
    private void getFeedList(String page) {
        if (!noMoreFeedItems) {
            if (cd.isConnectingToInternet()) {
                requestPresenter.getGroupFeedList(GET_FEED_LIST_WITH_FILTER, PreferenceUtils.getId(mContext),
                        group.getId(), "", page);
            } else {
    ...
    public void onEditPost(int position, FeedItem feedItem) {
        ...
        intent.putExtra("groupPost", true);
    ...
    @OnClick({R.id.et_group_message})
    @Override
    public void onClick(View view) {
        switch (view.getId()) {

            case R.id.et_group_message:
