...
import com.app.smeezy.adapter.TradeFeedAdapter;
...
public class TradeFeedFragment extends BaseFragment implements View.OnClickListener, IRequestView,
        TradeFeedListener {
    ...
    private TradeFeedAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new TradeFeedAdapter(mContext, recyclerView, feedList, this);
        ...
        if (!noMoreFeedItems) {
            if (cd.isConnectingToInternet()) {
                requestPresenter.getStuffFeedList(GET_STUFF_FEED_LIST_WITH_FILTER,
                        PreferenceUtils.getId(mContext), "trade", page, categorySlug,
