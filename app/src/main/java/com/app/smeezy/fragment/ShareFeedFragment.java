...
import com.app.smeezy.adapter.ShareFeedAdapter;
import com.app.smeezy.interfacess.IRequestView;
import com.app.smeezy.interfacess.ShareFeedListener;
...
public class ShareFeedFragment extends BaseFragment implements View.OnClickListener, IRequestView,
        ShareFeedListener {
    ...
    private static final int REPORT_REQUEST = 1684;
    ...
    private ShareFeedAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new ShareFeedAdapter(mContext, recyclerView, feedList, this);
        ...
        if (!noMoreFeedItems) {
            if (cd.isConnectingToInternet()) {
                requestPresenter.getStuffFeedList(GET_STUFF_FEED_LIST_WITH_FILTER,
                        PreferenceUtils.getId(mContext), "share", page, categorySlug,
    ...
    public void onAskToBorrow(StuffFeedItem stuffFeedItem) {
        //showMessageDialog(stuffFeedItem, "ask_borrow");
    ...
    private void showMessageDialog(final StuffFeedItem stuffFeedItem, final String action) {
                    ...
                    if (cd.isConnectingToInternet()) {
                      /*  startProgressBar();
                        requestPresenter.composeMessageStuff(COMPOSE_MESSAGE, PreferenceUtils.getId(mContext),
                                stuffFeedItem.getUserId(), message, "share",
                                stuffFeedItem.getId());*/
                    } else {
                        Utills.noInternetConnection(mContext);
                    }
